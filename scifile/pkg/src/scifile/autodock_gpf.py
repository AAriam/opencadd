...
def from_spec(
    ...
    npts: tuple[int, int, int] = (40, 40, 40),
    spacing: float = 0.375,
    receptor_types: str | Sequence[str] = ("A", "C", "HD", "N", "OA", "SA"),
    ...
    return AutodockGpfFile(
        ...
        npts=npts,
        spacing=spacing,
        receptor_types=[receptor_types] if isinstance(receptor_types, str) else receptor_types,
        ligand_types=[ligand_types] if isinstance(ligand_types, str) else ligand_types,
