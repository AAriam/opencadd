...
def manager(
    ...
    *,
    ...
    dirpath_chemsys: Path | str = "structure/6-system",
    ...
    dirpath_merged_features: Path | str = "merged-features",
    ...
    return Manager(
        ...
        dirpath_chemsys=dirpath_chemsys,
        ...
        dirpath_merged_features=dirpath_merged_features,
