...
def validate(
    ...
    args = {}
    for name, value, validator, none_allowed in (
        ("filter_function", filter_function, _validator_function, True),
        ("filter_radius", filter_radius, _validator.is_positive_number, True),
        ("filter_extension_mode", filter_extension_mode, _validator_extension_mode, False),
        ("filter_extension_constant_value", filter_extension_constant_value, _validator.is_real_number, False),
        ("filter_gaussian_sigma", filter_gaussian_sigma, _validator.is_positive_number, True),
        ("filter_percentile", filter_percentile, _validator_percentile, False),
    ):
    ...
    for feature_type in feature_types:
        ...
        radius = args["filter_radius"][feature_type] or feature_radius[feature_type]
